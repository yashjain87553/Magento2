 ...
 */
namespace Lensinfo\Save\Block\Order;
...
class Totals extends \Magento\Framework\View\Element\Template
{
    ...
    public function __construct(
        ...
        \Lensinfo\Save\Model\ResourceModel\Lensinfosave\CollectionFactory $lensinfosave,
        array $data = []
    ) {
    ...
    protected function _initTotals()
    {
         ...
         * Add shipping
         */
        $collection = $this->lensinfosave->create()->addFieldToFilter('order_id',$order_id)->getData();
         foreach($collection as $data)
         {
            $name=$data['name'];
            $cost=$data['cost'];
            $this->_totals[$name] = new \Magento\Framework\DataObject(
                [
                    'code' => $name,
                    'field' => $name,
                    'value' => $cost,
